    ...
    return {
      c() {
        (e = w("div")),
          ...
          p(l, "for", "nickname"),
          p(a, "name", "nickname"),
          p(a, "class", "bg-base-300 form-control w-full h-fit textarea"),
          p(a, "type", "text"),
          ...
          p(o, "for", "email"),
          p(u, "name", "email"),
          p(u, "class", "bg-base-300 form-control w-full h-fit textarea"),
          p(u, "type", "email"),
          p(u, "title", A("email")),
          p(s, "class", "px-1"),
          ...
          p(m, "class", "bg-base-300 form-control w-full h-fit textarea"),
    ...
    return {
      c() {
        (e = w("div")),
          ...
          p(v, "class", "my-2 dark:text-gray-200"),
