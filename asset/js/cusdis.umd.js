(function ($) {
    ...
    return {
      c() {
        (e = w("div")),
          ...
          p(l, "for", "nickname"),
          p(a, "name", "nickname"),
          p(a, "class", "bg-base-200 dark:bg-base-300 form-control w-full h-fit textarea"),
          p(a, "type", "text"),
          ...
          p(o, "for", "email"),
          p(u, "name", "email"),
          p(u, "class", "bg-base-200 dark:bg-base-300 form-control w-full h-fit textarea"),
          p(u, "type", "email"),
          p(u, "title", A("email")),
          p(s, "class", "px-1"),
          ...
          p(m, "class", "bg-base-200 dark:bg-base-300 form-control w-full h-fit textarea"),
  ...
  class Ee extends fe {
    constructor(e) {
      super(), ce(this, e, Ge, We, le, { comment: 1, showReplyForm: 0, isChild: 2 });
    }
  }
  function Ne(t, e, r) {
    const n = t.slice();
  ...
  function Ze(t, e, r) {
    ...
    async function v(b = 1) {
      r(3, (a = !0));
      try {
        const m = await f.get("/api/open/comments", { headers: { "x-timezone-offset": -new Date().getTimezoneOffset() }, params: { page: b, appId: n.appId, pageId: n.pageId } });
        r(0, (l = m.data.data));
      } catch (m) {
        r(5, (s = m));
      } finally {
